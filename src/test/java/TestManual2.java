...
public class TestManual2 {
    ...
    static final TextStyle BULLET_TEXT_STYLE = new TextStyle(PDType1Font.HELVETICA, 12f, CMYK_BLACK);
...
//            System.out.println("pageNum " + pageNum);
                    ...
                    pb.drawStyledText(leftMargin, 20f, "Page # " + pageNum,
                                      new TextStyle(PDType1Font.HELVETICA, 9f, CMYK_BLACK));
                    return leftMargin;
                });
...
//                        .buildTable();
        ...
        lp.drawCell(0, PDRectangle.A6.getHeight() - 40f,
                    Cell.of(CellStyle.of(TOP_LEFT, Padding.of(2), CMYK_LIGHT_GREEN,
                            ...
                            vec(new Text(new TextStyle(PDType1Font.HELVETICA, 12f, CMYK_BLACK),
                                        "The long "),
                                new Text(new TextStyle(PDType1Font.HELVETICA_BOLD, 12f, CMYK_BLACK),
                                        "families"),
                                new Text(new TextStyle(PDType1Font.HELVETICA, 12f, CMYK_BLACK),
                                        " needed the national " +
