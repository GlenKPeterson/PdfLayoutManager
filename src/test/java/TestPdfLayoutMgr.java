    ...
    public void testPdf() throws IOException, COSVisitorException {
        ...
        XyOffset xya =
                lp.tableBuilder(XyOffset.of(40f, lp.yPageTop()))
                  ...
                  .cellBuilder().align(TOP_CENTER).add("Line 1", "Line two", "Line 3").buildCell()
                  .cellBuilder().align(TOP_RIGHT).add("Line 1", "Line two", "Line 3").buildCell()
                  .buildRow()
                  .rowBuilder()
                  .cellBuilder().align(MIDDLE_LEFT).add("Line 1", "Line two", "Line 3").buildCell()
                  .cellBuilder().align(MIDDLE_CENTER).add("Line 1", "Line 2", "Line 3").buildCell()
                  .cellBuilder().align(MIDDLE_RIGHT).add("Line 1", "Line two", "Line 3").buildCell()
                  .buildRow()
                  .rowBuilder()
                  .cellBuilder().align(BOTTOM_LEFT).add("Line 1", "Line two", "Line 3").buildCell()
                  .cellBuilder().align(BOTTOM_CENTER).add("Line 1", "Line 2", "Line 3").buildCell()
                  .cellBuilder().align(BOTTOM_RIGHT).add("Line 1", "Line two", "Line 3").buildCell()
                  .buildRow()
                  .buildPart()
                  .buildTable();
        ...
        lp.tableBuilder(XyOffset.of(xya.x() + 10, xyb.y() - 10))
          ...
          .partBuilder().cellStyle(CellStyle.of(MIDDLE_CENTER, Padding.of(2),
                                                ...
                                                BorderStyle.of(DARK_GRAY)))
          .textStyle(TextStyle.of(PDType1Font.COURIER, 12f, BLACK))
          .rowBuilder().cellBuilder().align(BOTTOM_RIGHT).add("Line 1").buildCell()
          .cellBuilder().align(BOTTOM_CENTER).add("Line 1", "Line two").buildCell()
          .cellBuilder().align(BOTTOM_LEFT)
          .add("Line 1", "Line two", "[Line three is long enough to wrap]").buildCell()
          .buildRow()
          .rowBuilder().cellBuilder().align(MIDDLE_RIGHT).add("Line 1", "Line two").buildCell()
          .cellBuilder().align(MIDDLE_CENTER).add("").buildCell()
          .cellBuilder().align(MIDDLE_LEFT).add("Line 1").buildCell().buildRow()
          .rowBuilder().cellBuilder().align(TOP_RIGHT).add("L1").buildCell()
          .cellBuilder().align(TOP_CENTER).add("Line 1", "Line two").buildCell()
          .cellBuilder().align(TOP_LEFT).add("Line 1").buildCell().buildRow()
          .buildPart()
          .buildTable();
