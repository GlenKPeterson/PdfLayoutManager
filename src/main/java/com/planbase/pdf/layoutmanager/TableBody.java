...
public class TableBody {
    ...
    private TableBody(TableBuilder t, float[] a, CellStyle b, TextStyle c) {
        tableBuilder = t; cellWidths = a; cellStyle = b; textStyle = c;
    }

//    public static TableBody of(float[] cellWidths, CellStyle cellStyle, TextStyle textStyle) {
//        return new TableBody(cellWidths, cellStyle, textStyle);
//    }

    public float[] cellWidths() { return cellWidths; }
//    public TableBody cellWidths(float[] x) { return new Builder().cellWidths(cellWidths).build(); }

    public CellStyle cellStyle() { return cellStyle; }
//    public TableBody cellStyle(CellStyle x) { return new Builder().cellStyle(cellStyle).build(); }

    public TextStyle textStyle() { return textStyle; }
//    public TableBody textStyle(TextStyle x) { return new Builder().textStyle(textStyle).build(); }
    ...
    public static class Builder {
        ...
        public TableBody build() { return new TableBody(tableBuilder, cellWidths, cellStyle, textStyle); }
